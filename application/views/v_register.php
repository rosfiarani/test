...
<head>
    ...
    <!-- Main CSS-->
    <link href="<?php echo base_url();?>css/main_R.css" rel="stylesheet" media="all">
</head>
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo site_url('register/aksi_register'); ?>">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="Alamat" name="alamat">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="no_telpon">
                                   <!--  <div class="p-t-10">
                        ...
                        <div class="p-t-15">
                            <button class="submit btn btn--radius-2 btn--green" type="submit">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
