            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <div class="ket">
                    <a class="ketbutton" href="<?php echo base_url();?>admin_barang/viewBarang?idBarang=<?php echo $d->idBarang ?>"><i class="fa fa-eye"></i></a>
                    <a class="ketbutton" href=" <?php echo base_url();?>admin_barang/editBarangView?idBarang=<?php echo $d->idBarang ?>"><i class="fa fa-pencil"></i></a>
                    <a class="ketbutton" href="<?php echo site_url('admin_barang/hapusBarang/'.$d->idBarang) ?>"><i class="fa fa-trash-o"></i></i></a>
                  </div>
                  </td>
                </tr>
              <?php }?>
