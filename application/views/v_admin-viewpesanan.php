        ...
        <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                      ...
                      <div class="col-1">:</div>
                      <div class="col-8"><?php echo $d['0']->idTransaksi?></div>
              </div>
              <div class="row">
                      <div class="col-3">username</div>
                      <div class="col-1">:</div>
                      <div class="col-8"><?php echo $d['0']->username?></div>
              </div>
              <div class="row">
                      <div class="col-3">tanggal Pemesanan</div>
                      <div class="col-1">:</div>
                      <div class="col-8"><?php echo $d['0']->tanggalPemesanan?></div>
              </div>
              <div class="row">
                      <div class="col-3">status Pembayaran</div>
                      <div class="col-1">:</div>
                      <div class="col-8"><?php echo $d['0']->statusPembayaran?></div>
              </div>
              <div class="row">
                      <div class="col-3">tanggal Pembayaran</div>
                      <div class="col-1">:</div>
                      <div class="col-8"><?php echo $d['0']->tanggalPembayaran?></div>
              </div>
              <div class="row">
                      <div class="col-3">total Bayar</div>
                      <div class="col-1">:</div>
                      <div class="col-8"><?php echo $d['0']->totalBayar?></div>
              </div>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td style="width:25%"><img src="<?php echo base_url();?><?php echo $b->gambar1;?>" alt="no image"></td>
                </tr>
              <?php }?>
                </tbody>
