    ...
    <div class="row">
      <div class="col-3">
        <div class="list-group" id="list-tab" role="tablist">
          <a class="list-group-item list-group-item-action active show" id="list-profile-list" data-toggle="list" href="#list-profile" role="tab" aria-controls="profile" aria-selected="false">Detail Account</a>
          ...
          <a class="list-group-item list-group-item-action" id="list-payment-list" data-toggle="list" href="#list-payment" role="tab" aria-controls="messages" aria-selected="true">Payment Confirmation</a>
      ...
      <div class="col-9">
        <div class="tab-content" id="nav-tabContent">
          <div class="tab-pane active show" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">
          ...
          <div class="tab-pane" id="list-payment" role="tabpanel" aria-labelledby="list-payment-list">
            <h3 class="title m-b-20">Payment Confirmation</h3>
              <form action="<?php echo site_url('account/pembayaran');?>" method="post">
                <?php $transaksi = $this->session->dataTransaksi; ?>
                <div class="form-group row">
                  <label for="paymentcode" class="col-sm-3 col-form-label">Payment Code</label>
                  <div class="col-sm-9">
                  <input type="text" readonly class="form-control-plaintext" id="idTransaksi" name="idTransaksi" value="<?php echo $transaksi['idTransaksi'];?>">
                </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" readonly class="form-control-plaintext" id="" value="<?php echo $transaksi['total']; ?>">
                  </div>
                </div>
                <div class="form-group row">
                <label for="example-date-input" class="col-3 col-form-label">Payment Date</label>
                <div class="col-sm-9">
                  <input class="form-control" type="date" id="tanggalPembayaran" name="tanggalPembayaran">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="staticmethod" class="col-sm-3 col-form-label">Payment Method</label>
                  <div class="col-sm-9">
                    <input type="text" readonly class="form-control-plaintext" id="staticmethod" value="Virtual Account">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="staticpayment" class="col-sm-3 col-form-label">Bank Account</label>
                  <div class="col-sm-9">
                    <input type="text" readonly class="form-control-plaintext" id="staticpayment" value="BNI">
                  </div>
                </div>
